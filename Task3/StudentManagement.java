...
public class StudentManagement {
    ...
    private static void addStudent() {
        ...
        do {
            ...
            isRollUnique = isRollUnique(roll);

            if (!isRollUnique) {
                System.out.println("Student with the same number already exists. Please enter a unique student number.\n");
                System.out.print("\nEnter student number: ");
            }
        ...
        studList.add(new Student(studName, roll, address, marks, totalMarks, numberOfSubjects, grade, averagePercentage));
    }
        
        private static boolean isRollUnique(int roll) {
                ...
                do {
                    ...
                    switch (choice) {
                        case 1:
                            ...
                            break;
                        case 2:
                            System.out.print("\nPlease enter Student  Roll : ");
                            stud.roll = scanner.nextInt();
                            System.out.println("\nUpdate successful!");
                            break;
                        case 3:
                            System.out.print("\nPlease enter Student  Address : ");
                            stud.address = scanner.nextLine();
                            System.out.println("\nUpdate successful!");
                            break;    
                    }
    ...
    private static void displayStudent() {
        ...
        for (int i = 0; i < studList.size(); i++) {
            ...
            System.out.println("\nStudent RollNumber : " + studList.get(i).roll);
            System.out.println("\nStudent Address : " + studList.get(i).address);
